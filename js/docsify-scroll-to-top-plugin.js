...
var scrollToTopPlugin = function (hook, vm) {
    ...
    hook.mounted(function() {
        ...
        scrollBtn.style.color = 'var(--text-color-base)';
        scrollBtn.style.border = '1px solid var(--text-color-base)';
        ...
        scrollBtn.style.boxShadow = '0px 0px 6px var(--text-color-base)';

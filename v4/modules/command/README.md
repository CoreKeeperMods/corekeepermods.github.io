...
## Usage Example
Make sure to call `CoreLibMod.LoadSubmodule(typeof(CommandModule));` to in your mod `EarlyInit()` function, before using the module. This will load the submodule.
...
CommandModule.AddCommands(modInfo.ModId, "My Mod");
```

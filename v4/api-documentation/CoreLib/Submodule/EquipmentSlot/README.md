...
# `CoreLib.Submodule.EquipmentSlot` Namespace

> Equipment slot submodule supporting custom equipment slots and emotes, with stable ID binding and prefab registration helpers.

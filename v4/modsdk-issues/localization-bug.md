...
?> **Note:** Move to using `TextDataBlocks` as of Core Keeper v1.2.0 [here](https://modding.corekeepergame.com/documentation/creating-mods/creating-a-mod/how-to-localize-your-mod)
